...
// Structure for a linked list of expressions (used in function call arguments)
struct expr_list {
  struct expr * exp;
...
// Constructors for expressions, expression list and commands
